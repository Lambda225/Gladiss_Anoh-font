...
function Inscription() {
  return (
    <div className='bg-rose-50 min-h-screen flex flex-col items-center py-20 md:flex-row sm:gap-x-5 lg:gap-x-14 sm:justify-center '>
        <form action="#" className='flex flex-col w-11/12 sm:w-[80%] md:w-[55%] lg:w-[45%] 2xl:w-[25%] items-center bg-white px-[8%] py-9 lg:py-7 sm:p-[6%] lg:px-[4%] 2xl:px-[2%] rounded-lg shadow-3xl'>
            <h1 className='text-2xl 2xl:text-3xl font-semibold mb-12 relative pb-3 after:absolute after:left-[50%] after:bottom-0 after:translate-x-[-50%] after:h-[2px] after:w-3/5 after:bg-marron-200'>Inscription</h1>
            ...
            <div className='flex justify-start items-center mb-6 w-full'><input type="checkbox" id='souvenir' className=' h-5 w-5 mr-4 2xl:text-xl' /><label htmlFor="souvenir">Se souvenir de moi</label></div>
            <button className='w-full py-4 text-white bg-blue-200 rounded-lg mb-4 2xl:text-xl'>S'inscrire</button>
            <NavLink to='/connexion' ><p className='font-semibold text-marron-200 2xl:text-xl'>Se connecter</p></NavLink>
        </form>
      <p className='w-4/5 md:w-[40%] lg:w-[30%] mt-14 2xl:text-2xl'>Lorem ipsum dolor sit amet consectetur adipisicing elit. Consequatur repudiandae labore totam corporis ut, dolore a pariatur animi enim laborum sunt doloribus eaque placeat mollitia neque necessitatibus obcaecati provident distinctio?</p>
    </div>
  )
}
