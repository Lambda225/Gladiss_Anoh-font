  ...
  return (
    <div className=' relative'>
        ...
        <div className='px-[10%] my-20'>
            <h2 className='text-center text-xl font-semibold mb-12'>A propos</h2>
        ...
        <div className='mb-20'>
            <h2 className='text-center text-xl font-semibold mb-12'>Contact</h2>
            <div className='flex flex-col items-center px-[6%] md:flex-row md:gap-x-7 md:justify-center'>
                ...
                <form action="#" className='flex flex-col items-center mt-16 shadow-3xl w-full sm:w-9/12 md:w-1/2 lg:w-[40%] px-[15%] sm:px-[10%] md:px-[6%] py-14 rounded-lg'>
                    <h3 className='text-xl font-semibold mb-7 w-9/12 text-center relative after:absolute after:bottom-0 after:left-1/2 after:h-[2px] after:w-4/12 after:bg-marron-200 after:translate-x-[-50%] pb-4'>Envoyer nous un message</h3>
                    <input type="text" placeholder='Nom' className='py-2 border-b-2 border-blue-200 w-full focus:outline-none mb-7' />
                    <input type="email" placeholder='Mail' className='py-2 border-b-2 border-blue-200 w-full focus:outline-none mb-7' />
                    <textarea name="" id="" rows="2" placeholder='Message' className='px-2 border-b-2 border-blue-200 w-full focus:outline-none mb-7 resize-none'></textarea>
                    <button className='py-3 w-full rounded-lg bg-blue-200 text-white'>Envoyer</button>
                </form>
            </div>
        </div>
