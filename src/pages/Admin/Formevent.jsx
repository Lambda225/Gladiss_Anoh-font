        ...
        <div className='w-3/4 h-screen overflow-y-scroll'>
          ...
          <div className='bg-rose-50 py-10 flex justify-center items-center min-h-full'>
            <form action="#" className='flex flex-col w-6/12 items-center bg-white px-[8%] py-9 lg:py-7 sm:p-[6%] lg:px-[4%] rounded-lg shadow-3xl'>
                ...
                <input type="text" placeholder="Coût" className='w-full bg-transparent border-b-2 border-blue-200 py-2 mb-8 focus:outline-none'/>
                <input type="text" placeholder="Date de L'évenement " className='w-full bg-transparent border-b-2 border-blue-200 py-2 mb-8 focus:outline-none' onFocus={(e) => {e.target.type="date"}} onBlur={(e) => {e.target.value ? e.target.type = "text" : e.target.type="date"}} onClick={(e) => {e.target.type="date"}}/>
