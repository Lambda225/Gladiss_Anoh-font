...
function Formlivre() {
  ...
  const hundelSubmit = e =>{
    ...
    formData.append('lien_achat',link)
    ...
    console.log({'Titre':title,'Image':image,'Description':desc,'Lien':link});
  }
  return (
    <div className='flex'>
        <Adnavbar />
        <div className='w-3/4 h-screen overflow-y-scroll'>
          ...
          <div className='bg-rose-50 py-10 flex justify-center items-center min-h-full'>
            <form action="#" className='flex flex-col w-6/12 items-center bg-white px-[8%] py-9 lg:py-7 sm:p-[6%] lg:px-[4%] rounded-lg shadow-3xl' onSubmit={hundelSubmit}>
                ...
                <input type="text" placeholder="Lien D'achat" className='w-full bg-transparent border-b-2 border-blue-200 py-2 mb-8 focus:outline-none' onChange={ e => setlink(e.target.value) }/>
