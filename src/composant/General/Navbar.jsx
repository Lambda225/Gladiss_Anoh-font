...
import { BellIcon,ChatIcon,UserIcon,DotsVerticalIcon,ChevronRightIcon, ChevronLeftIcon } from '@heroicons/react/solid'
  ...
  return (
    <div>
         <nav className='flex justify-between py-8 px-7 bg-rose-50 border-[1px] border-b-marron-200 fixed w-full z-30'>
            <div className='flex'>
                <h1 className='font-bold items-center flex text-2xl 2xl:text-4xl'><NavLink to="/">LOGO</NavLink></h1>
                <ul className='hidden md:flex items-center ml-8'>
                    <NavLink to='/forum'><li className='mx-3 2xl:text-2xl'>Forum</li></NavLink>
                    <li className='mx-3 group relative'>
                        ...
                        <ul className='bg-white hidden group-hover:block absolute bottom-[-52px] 2xl:bottom-[-60px] translate-y-1/2 left-0 rounded-lg border-[1px] border-gray-400 overflow-hidden'>
                            <li className='mb-2 2xl:text-2xl hover:bg-gray-100 py-3 px-5'><NavLink to='/article'>Article</NavLink></li>
                            <li className='2xl:text-2xl hover:bg-gray-100 py-3 px-5'><NavLink to='/podcast'>Podcast</NavLink></li>
                        </ul>
                    </li>
                    <NavLink to='/calendrier'><li className='mx-3 2xl:text-2xl'>Calendrier</li></NavLink>
                    <NavLink to='/boutique' ><li className='mx-3 2xl:text-2xl'>Boutique</li></NavLink>
                    <NavLink to='/apropos' ><li className='mx-3 2xl:text-2xl'>A propos</li></NavLink>
                </ul>
            </div>
            <div className='hidden sm:flex justify-center items-center'>
                <NavLink to='/message'><div><ChatIcon className='h-6 mx-2 2xl:h-10'/></div></NavLink>
                <div><BellIcon className='h-6 mx-2 2xl:h-10'/></div>
                <NavLink to='/connexion' ><div className='h-16 w-16 2xl:h-20 2xl:w-20 mx-2 rounded-full bg-white flex justify-center items-center'><UserIcon className='h-10 2xl:h-14'/></div></NavLink>
        ...
        <div className={`fixed w-full h-screen z-50 bg-white top-0 duration-200 ease-ino overflow-y-scroll sm:overflow-auto sm:w-1/2 ${!nav ? 'right-[-100%]' : 'right-0'}`}>
            ...
            <ul className='flex flex-col relative overflow-hidden'>
                ...
                <li className='px-8 py-5 border-b-2 border-marron-200 flex justify-between' onClick={e=>{setsousmenu(!sousmenu)}}>Post <ChevronRightIcon className='h-6'/></li>
                ...
                <ul className={`absolute top-0 duration-300 ${sousmenu? 'right-0': 'right-[-100%]'} bg-white h-screen w-full`}>
                    <div className='flex mb-4 cursor-pointer' onClick={e=>{setsousmenu(!sousmenu)}}><ChevronLeftIcon className='h-6'/> <span className='ml-4'>Ressources</span></div>
                    <li className='px-8 py-5 border-b-2 border-marron-200'><NavLink to='/article'>Article</NavLink></li>
                    <li className='px-8 py-5 border-b-2 border-marron-200'><NavLink to='/podcast'>Podcast</NavLink></li>
                </ul>
            </ul>
