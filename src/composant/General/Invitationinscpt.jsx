  ...
  return (
    <div className='flex px-[6%] py-10 bg-rose-50 flex-col sm:flex-row sm:gap-5'>
        <div className='md:w-3/5'>
            ...
            <p className='2xl:text-2xl'>l'incription est le meilleur moyenne d'obtenir des newsletters de notre part parlant de nos seminaire de formation, des articles et podcasts poster </p>
        </div>
