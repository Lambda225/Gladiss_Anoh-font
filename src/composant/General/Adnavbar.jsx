    ...
    <div className='lg:w-1/4'>
      ...
      <h2 className='text-2xl font-semibold'>LOGO</h2>
        ...
        <ul className='flex flex-col w-full items-start'>
            ...
            <NavLink to='/admin/livre' className='w-full'><li className='px-7 w-full py-3 font-semibold cursor-pointer'>Livre</li></NavLink>
            <NavLink to='/admin/evenement' className='w-full'><li className='px-7 w-full py-3 font-semibold cursor-pointer'>Evenement</li></NavLink>
            <NavLink to='/admin/avis' className='w-full'><li className='px-7 w-full py-3 font-semibold cursor-pointer'>Avis Internaute</li></NavLink>
        </ul>
      </div>
