    ...
    <div className={`absolute flex flex-col items-center top-0 ease-out duration-300 bg-white w-full md:w-1/2 py-7 ${props.contVisible ? " right-0" : "right-[-100%]" } md:right-0`}>
        ...
        <div className='cartinvite mt-14 w-[80%] sm:w-[60%] md:w-3/4 lg:w-[60%] 2xl:w-[45%]'>
            <div className="flex items-center mb-20">
                <div className=' h-28 w-24 mt-[-55px] rounded-lg bg-blue-200 2xl:h-44 2xl:w-36'></div>
                <h3 className=' text-lg font-semibold ml-7 2xl:text-xl'>N° 3</h3>
            </div>
            <div className='flex flex-col items-center pt-7 border-t-2 border-gray-300'>
                <h3 className=' text-xl font-semibold text-center mb-3 2xl:text-4xl'>Evenement</h3>
                <div className="">
                ...
                <a href="#" className='py-4 px-7 text-center mt-2 rounded-lg bg-blue-200 text-white 2xl:text-xl'>Accéder au forum</a>
            </div>
        </div>
    </div>
  )
