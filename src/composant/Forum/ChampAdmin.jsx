...
function ChampAdmin({setschear,setcompte,compte,qustSlt,setqustBool,qustBool}) {
    ...
    const hundelSubmit = (e) =>{
        ...
        formData.append('quest_id',qustSlt)
